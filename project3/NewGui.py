...
keyboard.on_press_key(" ", lambda e: boost_button_press()) # Start boost when space is pressed
# Keyboard Binding for Diagonal Movements: WA, WD, SA, SD
keyboard.on_press_key("w", lambda e: wa_button_press())  # (up + left)
keyboard.on_press_key("a", lambda e: wa_button_press())  # (up + left)
keyboard.on_press_key("w", lambda e: wd_button_press())  # (up + right)
keyboard.on_press_key("d", lambda e: wd_button_press())  # (up + right)
keyboard.on_press_key("s", lambda e: sa_button_press())  # (down + left)
keyboard.on_press_key("a", lambda e: sa_button_press())  # (down + left)
keyboard.on_press_key("s", lambda e: sd_button_press())  # (down + right)
keyboard.on_press_key("d", lambda e: sd_button_press())  # (down + right)
# Key Release bindings to stop movement when keys are released
...
keyboard.on_release_key(" ", lambda e: button_release()) # Stop boost when space is released
